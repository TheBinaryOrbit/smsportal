...
const AttendancePage = () => {
  ...
  const [attendanceFormat, setAttendanceFormat] = useState('format1') // Default to format1
  ...
  const handleFormatChange = (e) => {
    setAttendanceFormat(e.target.value)
  }
  ...
  const handleUpload = async () => {
    ...
    formData.append('attendanceFormat', attendanceFormat)
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4 p-4 bg-green-50 rounded-lg border border-green-200">
            <div className="flex items-center gap-2">
              ...
              <label className="text-sm font-medium text-green-900">SMS Format:</label>
            </div>
            <select
            ...
            >
              <option value="format1">Format 1: Work Hours (197597)</option>
              <option value="format2">Format 2: Attendance Status (197982)</option>
            </select>
            <span className="text-sm text-green-700">
              {attendanceFormat === 'format1' ? 'Shows work hours and duration' : 'Shows attendance status'}
            </span>
          </div>
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                {attendanceFormat === 'format1' 
                  ? 'Columns: Name (E), Phone (L), Employee ID (C), In Time (G), Out Time (H), Work Duration (K)'
                  : 'Columns: Name (E), Phone (L), Employee ID (C), Attendance Status (M)'
                }
              </p>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-green-700">
                    ...
                    Format: {attendanceFormat === 'format1' ? 'Work Hours' : 'Attendance Status'}
                  </div>
                </div>
              </div>
              <button
