...
import { Upload, FileSpreadsheet, CheckCircle, AlertCircle, Clock, BarChart3 } from "lucide-react"
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                Columns: Name (A), Phone (B), Status (C), Date (D)
              </p>
            </div>
              ...
              <div key={record._id} className="flex items-center justify-between p-4 border border-red-200 rounded-lg bg-red-50">
                <div>
                  ...
                  <div className="text-sm text-red-600">
                    {record.data.date} - {record.data.status}
                  </div>
